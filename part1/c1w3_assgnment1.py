...
def layer_sizes(X, Y):
    """
    Arguments:
    X -- input dataset of shape (input size, number of examples) (2,3)
    Y -- labels of shape (output size, number of examples)       (1,3)
    Returns:
...
def compute_cost(A2, Y, parameters):
    ...
    ### END CODE HERE ###
    # cost1 = - np.sum([Y * np.log(A2) + (1 -Y) * np.log(1-A2)]) /m
    # print(cost1)
...
def nn_model(X, Y, n_h, num_iterations=10000, print_cost=False):
    """
    Arguments:
    X -- dataset of shape (2, number of examples) (2,3)
    Y -- labels of shape (1, number of examples)  (1,3)
    n_h -- size of the hidden layer
